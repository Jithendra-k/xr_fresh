...
#     @staticmethod
#     def _interpolate_nans_interp1d(array, kind):
#         nan_check = np.isnan(array)
#         if all(nan_check) or all(~nan_check):
#             return array
#         else:
#             valid_indices = np.where(~nan_check)[0]
#             valid_values = array[valid_indices]
#             inter_fun = interp1d(valid_indices, valid_values, kind=kind, bounds_error=False, fill_value="extrapolate")
#             return inter_fun(np.arange(len(array)))
...
#             valid_dates = self.date_indices[valid_indices]
#             valid_values = array[valid_indices]
#             inter_fun = interp1d(valid_dates, valid_values, kind=self.interp_type, fill_value="extrapolate")
#             return inter_fun(self.date_indices)
...
#             valid_indices = np.where(~nan_check)[0]
#             valid_values = array[valid_indices]
#             inter_fun = CubicSpline(valid_indices, valid_values, bc_type="not-a-knot")
#             return inter_fun(np.arange(len(array)))
...
#             valid_dates = self.date_indices[valid_indices]
#             valid_values = array[valid_indices]
#             inter_fun = CubicSpline(valid_dates, valid_values, bc_type="not-a-knot")
#             return inter_fun(self.date_indices)
...
#             valid_indices = np.where(~nan_check)[0]
#             valid_values = array[valid_indices]
#             inter_fun = UnivariateSpline(valid_indices, valid_values, s=s)
#             return inter_fun(np.arange(len(array)))
...
#             valid_date_indices = self.date_indices[valid_indices]
#             valid_values = array[valid_indices]
#             inter_fun = UnivariateSpline(valid_date_indices, valid_values, s=s)
#             return inter_fun(self.date_indices)
...
#         if self.interp_type == "linear":
#             if self.dates is None:
#                 array = np.apply_along_axis(self._interpolate_nans_interp1d, axis=0, arr=array, kind="linear")
#             else:
...
#             else:
#                 array = np.apply_along_axis(self._interpolate_nans_interp1d_with_dates, axis=0, arr=array, self=self)
